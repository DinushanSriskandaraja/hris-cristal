            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative hidden sm:block w-64">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full rounded-md border border-gray-300 bg-gray-50 pl-9 pr-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-black"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                    <div className="text-right hidden sm:block">
                        ...
                        <p className="text-xs text-gray-500 mt-1">{user?.role || 'Guest'}</p>
                    </div>
